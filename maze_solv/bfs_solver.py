...
def playMaze(text_surface_gen, text_surface_sol, text_surface_level, mazeFile, screen, clock):
    ...
    while not done and not close:
        ...
        if done == True:
            ...
            image_name = "mazes_solutions/bfs_"+ mazeFile[:-4] + ".png"
    ...
    print(f"-- finished bfs_{mazeFile} {time.time()-start_t0:.3f} s | Shortest Path Count: {shortest_path} | Area Explore: {area_explored:.2f} % -- ")